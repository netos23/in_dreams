...
DreamUser _$DreamUserFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    ...
    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'DreamUser',
...
class __$$DreamUserTemplateImplCopyWithImpl<$Res>
    extends _$DreamUserCopyWithImpl<$Res, _$DreamUserTemplateImpl>
...
abstract class _DreamUserTemplate implements DreamUser {
  const factory _DreamUserTemplate(
      {final String? id,
      required final String name,
      required final String surname,
      required final DateTime birthday,
